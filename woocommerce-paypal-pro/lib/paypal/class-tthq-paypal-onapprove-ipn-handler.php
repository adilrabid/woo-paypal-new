...
class PayPal_OnApprove_IPN_Handler {
	...
	public function setup_ajax_request_actions() {
		...
		add_action( PayPal_Utils::hook('onapprove_create_subscription', true), array(&$this, 'onapprove_create_subscription' ) );
		add_action( PayPal_Utils::hook('onapprove_create_subscription', true, true), array(&$this, 'onapprove_create_subscription' ) );
	}
    ...
    public function onapprove_create_subscription(){
		...
		PayPal_Utils::log( 'OnApprove ajax request received for createSubscription. On Page Button ID: ' . $on_page_button_id, true );
		 ...
		 */ 
		do_action( PayPal_Utils::hook('paypal_subscription_checkout_ipn_processed'), $this->ipn_data );
		do_action( PayPal_Utils::hook('payment_ipn_processed'), $this->ipn_data );
