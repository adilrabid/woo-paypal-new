 ...
 * Description: Easily adds PayPal Checkout and PayPal Pro payment gateways to the WooCommerce plugin so you can allow customers to checkout via credit card or PayPal.
 * Version: 4.0.0
 * Author: wp.insider
